...
Usage:
  npx @wenmai-ai/wenmai-skills install [skill-name ...] [options]
  npx @wenmai-ai/wenmai-skills list
...
function install(args) {
  ...
  if (unknownSkills.length > 0) {
    throw new Error(
      `Unknown skill${unknownSkills.length > 1 ? 's' : ''}: ${unknownSkills.join(', ')}. Run "npx @wenmai-ai/wenmai-skills list" to see available skills.`,
    );
  }
