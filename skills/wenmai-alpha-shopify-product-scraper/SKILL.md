---
name: wenmai-alpha-shopify-product-scraper
description: "Use when users need the Wenmai Alpha standard API `alpha_shopify_product_scraper` for Shopify Product Scraper, including Shopify 品牌站商品. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/shopify-product-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---

# Wenmai Alpha Shopify Product Scraper

## Purpose
Use this Skill to fetch Shopify Product Scraper data through Wenmai standard API. It is useful for Shopify 品牌站商品.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/alpha/shopify-product-scraper`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/alpha_shopify_product_scraper.py`
...
python3 scripts/alpha_shopify_product_scraper.py '{"mode": "url", "maxPages": 1, "storeUrls": [{"url": "https://www.allbirds.com"}], "maxProducts": 20}'
```
