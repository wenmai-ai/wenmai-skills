---
name: wenmai-alpha-target-scraper
description: "Use when users need the Wenmai Alpha standard API `alpha_target_scraper` for Target Scraper, including Target 商品搜索. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/target-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---

# Wenmai Alpha Target Scraper

## Purpose
Use this Skill to fetch Target Scraper data through Wenmai standard API. It is useful for Target 商品搜索.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/alpha/target-scraper`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/alpha_target_scraper.py`
...
python3 scripts/alpha_target_scraper.py '{"sort": "relevance", "searchQueries": ["laptop"], "maxSearchPages": 1, "maxRequestRetries": 3, "maxProductsPerSearch": 3}'
```
