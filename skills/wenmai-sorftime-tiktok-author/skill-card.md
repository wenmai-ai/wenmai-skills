...
Sorftime TikTok 达人搜索接口，通过固定 Wenmai standard API `tiktok_author` 返回可追溯的原始网关数据。

固定调用 Wenmai Sorftime standard API `tiktok_author`，不接受动态端点或其他操作。

- Provider: Sorftime
- Platform: TikTok
- Operation: `tiktok_author`
