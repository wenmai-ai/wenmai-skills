---
name: wenmai-xydc-asin-info
description: "Use when users need the Wenmai XYDC standard API `get_asin_info` for asin商品信息, including traceable Amazon ASIN, keyword, country, date, rank, traffic, order, BSR, ABA, variation, or advertising trend data as documented for this endpoint. Sends user parameters as a JSON POST body to `/wmapi/v1/xydc/get-asin-info` and returns raw gateway data for ecommerce operations, competitor monitoring, keyword research, or reporting."
metadata:
  version: "1.0.0"
---

# Wenmai XYDC ASIN Info

## Purpose
Use this Skill to call the Wenmai XYDC standard API `get_asin_info` for asin商品信息.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/xydc/get-asin-info`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/xydc_asin_info.py`
...
python3 scripts/xydc_asin_info.py '{"asins": ["B09PCSR9SX"], "country": "US"}'
```
