...
Sorftime 1688 平台产品SKU数据查询接口，通过固定 Wenmai standard API `ali1688_product_variations` 返回可追溯的原始网关数据。

固定调用 Wenmai Sorftime standard API `ali1688_product_variations`，不接受动态端点或其他操作。

- Provider: Sorftime
- Platform: 1688
- Operation: `ali1688_product_variations`
