---
name: wenmai-xydc-asin-info-trends
description: "Use when users need the Wenmai XYDC standard API `get_asin_info_trends` for asin商品信息趋势图（天）, including traceable Amazon ASIN, keyword, country, date, rank, traffic, order, BSR, ABA, variation, or advertising trend data as documented for this endpoint. Sends user parameters as a JSON POST body to `/wmapi/v1/xydc/get-asin-info-trends` and returns raw gateway data for ecommerce operations, competitor monitoring, keyword research, or reporting."
metadata:
  version: "1.0.0"
---

# Wenmai XYDC ASIN Info Trends

## Purpose
Use this Skill to call the Wenmai XYDC standard API `get_asin_info_trends` for asin商品信息趋势图（天）.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/xydc/get-asin-info-trends`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/xydc_asin_info_trends.py`
...
python3 scripts/xydc_asin_info_trends.py '{"asin": "B09PCSR9SX", "country": "US", "start_date": "2026-06-01", "end_date": "2026-06-07"}'
```
