# Wenmai Alpha Wayfair Listings Scraper API 参考

## 调用规范

- **请求地址**：`${WENMAI_API_ORIGIN:-https://all-api.wenmai-ai.com}/wmapi/v1/alpha/wayfair-listings-scraper`
...
- **接口编码**：`alpha_wayfair_listings_scraper`
- **接口说明**：Wayfair Listings Scraper
- **脚本入口**：`scripts/alpha_wayfair_listings_scraper.py`，脚本参数即标准 API POST Body JSON
...
```bash
curl -sS -X POST \
  "${WENMAI_API_ORIGIN:-https://all-api.wenmai-ai.com}/wmapi/v1/alpha/wayfair-listings-scraper" \
  -H "secret-key: $WENMAI_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{"startUrls": [{"url": "https://www.wayfair.com/furniture/sb0/sofas-c413892.html"}], "maxResults": 3}'
```
