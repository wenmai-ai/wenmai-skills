---
name: wenmai-alpha-wayfair-listings-scraper
description: "Use when users need the Wenmai Alpha standard API `alpha_wayfair_listings_scraper` for Wayfair Listings Scraper, including Wayfair 家居商品. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/wayfair-listings-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---

# Wenmai Alpha Wayfair Listings Scraper

## Purpose
Use this Skill to fetch Wayfair Listings Scraper data through Wenmai standard API. It is useful for Wayfair 家居商品.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/alpha/wayfair-listings-scraper`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/alpha_wayfair_listings_scraper.py`
...
python3 scripts/alpha_wayfair_listings_scraper.py '{"startUrls": [{"url": "https://www.wayfair.com/furniture/sb0/sofas-c413892.html"}], "maxResults": 3}'
```
