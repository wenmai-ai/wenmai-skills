...
description: "Use when users need the Wenmai Alpha standard API `alpha_tiktok_scraper` for Tiktok Scraper, including TikTok 视频、账号、话题和趋势. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/tiktok-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---
