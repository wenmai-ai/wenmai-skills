...
Sorftime TikTok 类目数据报告接口，通过固定 Wenmai standard API `tiktok_category_report` 返回可追溯的原始网关数据。

固定调用 Wenmai Sorftime standard API `tiktok_category_report`，不接受动态端点或其他操作。

- Provider: Sorftime
- Platform: TikTok
- Operation: `tiktok_category_report`
