...
description: "卖家精灵（SellerSprite）卖家精灵竞品查询接口，用于按 ASIN、品牌、卖家、类目、站点、月份、关键词或变体条件查找 Amazon 竞品及其指标。当用户提到竞品查询、相似 ASIN、品牌竞品、卖家商品、类目竞品、变体竞品或 SellerSprite competitor lookup 时触发此技能。即使用户未明确提及 卖家精灵（SellerSprite），只要任务需要上述接口能力，也应触发此技能。"
metadata:
  author: wenmai-ai
  version: "1.0.0"
---

# 卖家精灵（SellerSprite） Competitor Lookup

## Overview

调用 Wenmai 卖家精灵（SellerSprite） standard API `competitor_lookup`。只调用以下固定端点，不接受动态端点或其他操作：
