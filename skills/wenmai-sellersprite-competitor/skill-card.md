...
卖家精灵（SellerSprite）卖家精灵竞品查询接口，用于按 ASIN、品牌、卖家、类目、站点、月份、关键词或变体条件查找 Amazon 竞品及其指标。

固定调用 Wenmai 卖家精灵（SellerSprite） standard API `competitor_lookup`，不接受动态端点或其他操作。

- Provider: 卖家精灵（SellerSprite）
- Platform: Amazon（亚马逊）
- Operation: `competitor_lookup`
