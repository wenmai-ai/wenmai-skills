---
name: wenmai-alpha-mercadolibre-scraper
description: "Use when users need the Wenmai Alpha standard API `alpha_mercadolibre_scraper` for Mercadolibre Scraper, including MercadoLibre 拉美商品、卖家、评论和问答. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/mercadolibre-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---

# Wenmai Alpha Mercadolibre Scraper

## Purpose
Use this Skill to fetch Mercadolibre Scraper data through Wenmai standard API. It is useful for MercadoLibre 拉美商品、卖家、评论和问答.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/alpha/mercadolibre-scraper`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/alpha_mercadolibre_scraper.py`
