---
name: wenmai-alpha-newegg-product-scraper
description: "Use when users need the Wenmai Alpha standard API `alpha_newegg_product_scraper` for Newegg Product Scraper, including Newegg 商品. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/newegg-product-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---

# Wenmai Alpha Newegg Product Scraper

## Purpose
Use this Skill to fetch Newegg Product Scraper data through Wenmai standard API. It is useful for Newegg 商品.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/alpha/newegg-product-scraper`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/alpha_newegg_product_scraper.py`
...
python3 scripts/alpha_newegg_product_scraper.py '{"keywords": ["RTX 4070"], "maxItems": 3, "maxPages": 3, "productUrls": ["https://www.newegg.com/p/pl?d=Laptop"], "requestTimeoutSecs": 30}'
```
