...
description: "Use when users need the Wenmai Alpha standard API `alpha_walmart_reviews_scraper` for Walmart Reviews Scraper, including Walmart 商品或评论. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/walmart-reviews-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---
