---
name: wenmai-alpha-bestbuy-scraper
description: "Use when users need the Wenmai Alpha standard API `alpha_bestbuy_scraper` for Bestbuy Scraper, including Best Buy 商品检索. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/bestbuy-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---

# Wenmai Alpha Bestbuy Scraper

## Purpose
Use this Skill to fetch Bestbuy Scraper data through Wenmai standard API. It is useful for Best Buy 商品检索.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/alpha/bestbuy-scraper`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/alpha_bestbuy_scraper.py`
...
python3 scripts/alpha_bestbuy_scraper.py '{"zipCode": "10001", "maxResults": 3, "searchQuery": "laptop", "fetchProductDetails": true}'
```
