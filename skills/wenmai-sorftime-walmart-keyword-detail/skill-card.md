...
Sorftime Walmart 关键词详情接口，通过固定 Wenmai standard API `walmart_keyword_detail` 返回可追溯的原始网关数据。

固定调用 Wenmai Sorftime standard API `walmart_keyword_detail`，不接受动态端点或其他操作。

- Provider: Sorftime
- Platform: Walmart
- Operation: `walmart_keyword_detail`
