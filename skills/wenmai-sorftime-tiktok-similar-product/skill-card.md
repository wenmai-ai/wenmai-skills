...
Sorftime TikTok 相似产品查询接口，通过固定 Wenmai standard API `tiktok_similar_product` 返回可追溯的原始网关数据。

固定调用 Wenmai Sorftime standard API `tiktok_similar_product`，不接受动态端点或其他操作。

- Provider: Sorftime
- Platform: TikTok
- Operation: `tiktok_similar_product`
