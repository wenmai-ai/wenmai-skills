...
Sorftime TikTok 产品带货达人接口，通过固定 Wenmai standard API `tiktok_product_video_author` 返回可追溯的原始网关数据。

固定调用 Wenmai Sorftime standard API `tiktok_product_video_author`，不接受动态端点或其他操作。

- Provider: Sorftime
- Platform: TikTok
- Operation: `tiktok_product_video_author`
