---
name: wenmai-xydc-keyword-info
description: "Use when users need the Wenmai XYDC standard API `get_keyword_info` for 关键词信息（最近一周）, including traceable Amazon ASIN, keyword, country, date, rank, traffic, order, BSR, ABA, variation, or advertising trend data as documented for this endpoint. Sends user parameters as a JSON POST body to `/wmapi/v1/xydc/get-keyword-info` and returns raw gateway data for ecommerce operations, competitor monitoring, keyword research, or reporting."
metadata:
  version: "1.0.0"
---

# Wenmai XYDC Keyword Info

## Purpose
Use this Skill to call the Wenmai XYDC standard API `get_keyword_info` for 关键词信息（最近一周）.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/xydc/get-keyword-info`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/xydc_keyword_info.py`
...
python3 scripts/xydc_keyword_info.py '{"keywords": ["usb c cable"], "country": "US"}'
```
...
Required fields: `country, keywords`.
