---
name: wenmai-xydc-asin-variations
description: "Use when users need the Wenmai XYDC standard API `get_asin_variations` for 获取asin变体接口, including traceable Amazon ASIN, keyword, country, date, rank, traffic, order, BSR, ABA, variation, or advertising trend data as documented for this endpoint. Sends user parameters as a JSON POST body to `/wmapi/v1/xydc/get-asin-variations` and returns raw gateway data for ecommerce operations, competitor monitoring, keyword research, or reporting."
metadata:
  version: "1.0.0"
---

# Wenmai XYDC ASIN Variations

## Purpose
Use this Skill to call the Wenmai XYDC standard API `get_asin_variations` for 获取asin变体接口.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/xydc/get-asin-variations`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/xydc_asin_variations.py`
...
python3 scripts/xydc_asin_variations.py '{"asin": "B09PCSR9SX", "country": "US"}'
```
