...
Sorftime 1688 平台产品多维度搜索接口，通过固定 Wenmai standard API `ali1688_product_search` 返回可追溯的原始网关数据。

固定调用 Wenmai Sorftime standard API `ali1688_product_search`，不接受动态端点或其他操作。
