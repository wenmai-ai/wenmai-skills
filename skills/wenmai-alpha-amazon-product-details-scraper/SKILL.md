---
name: wenmai-alpha-amazon-product-details-scraper
description: "Use when users need the Wenmai Alpha standard API `alpha_amazon_product_details_scraper` for Amazon Product Details Scraper, including Amazon 商品、评论、Listing、竞品或搜索结果. Sends user parameters as a JSON POST body to `/wmapi/v1/alpha/amazon-product-details-scraper` and returns traceable raw gateway data for ecommerce research, competitor discovery, VOC, social trend analysis, or reporting."
---

# Wenmai Alpha Amazon Product Details Scraper

## Purpose
Use this Skill to fetch Amazon Product Details Scraper data through Wenmai standard API. It is useful for Amazon 商品、评论、Listing、竞品或搜索结果.

The Skill calls exactly one fixed standard API endpoint:

- Endpoint: `POST /wmapi/v1/alpha/amazon-product-details-scraper`
- Auth: Header `secret-key: $WENMAI_API_KEY`
- Script: `scripts/alpha_amazon_product_details_scraper.py`
...
python3 scripts/alpha_amazon_product_details_scraper.py '{"Params": ["B00091S3K4", "https://www.amazon.com/dp/B077Z99YGY"]}'
```
...
Required top-level fields: `Params`.
